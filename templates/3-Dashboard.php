<?php 
    ...
    {
        $today_expense = "Php ".$today_expense;
    }
    ...
    {
        $Yesterday_expense = "Php ".$Yesterday_expense;
    }
    ...
    {
        $monthly_expense = "Php ".$monthly_expense;
    }
    ...
    {
        $total_expenses = "Php ".$total_expenses;
    }
